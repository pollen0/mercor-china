#!/usr/bin/env python3
"""
Seed intern jobs from 2048 Ventures portfolio companies.

2048 Ventures is a thesis-driven early-stage VC (Pre-Seed/Seed) based in NYC
and Boston, focused on Vertical AI, Deep Tech, Health, and Bio.

Run with: cd apps/api && python -m scripts.seed_2048ventures_jobs
"""
import sys
import os
...
COMPANIES = [
    # ── Laminar ──
    {
        ...
        "email": "hello@runlaminar.com",
        "name": "Annie Lu",
        "industry": "Cleantech / Industrial AI",
        "company_size": "startup",
        "website": "https://runlaminar.com",
        "slug": "laminar",
        "description": (
            "Laminar builds ruggedized hardware and edge AI/ML solutions for "
            "the factory floor. Uses spectral sensors and AI co-pilot models to "
            "optimize manufacturing, water management, and energy reduction. "
            "Clients include Unilever, Coca-Cola, and AB InBev.\n\n"
        ...
        "jobs": [
            {
                ...
                "salary_max": 4700,
                "requirements": [
                    "Pursuing degree in Mechanical or Electrical Engineering",
                    "Demonstrated ability to work in team environments",
                    "Startup founder mindset and self-motivated",
                    "Commitment to environmental sustainability",
                ],
                "description": (
                    "Hardware Engineering Summer 2026 Internship at Laminar\n\n"
                    "Develop sensor and gateway products for cleantech applications. "
                    "Collaborate with hardware and software engineers on research and "
                    "implementation. Enhance hardware systems and drive product "
                    "innovation across mechanical and electrical components.\n\n"
                    "Potential for full-time conversion. Based at Greentown Labs.\n\n"
                    "Source: https://runlaminar.com/careers/eece5819-baee-4d47-ae33-fcbe80339743"
                ),
            },
            {
                ...
                "requirements": [
                    ...
                    "Interest in IoT, edge computing, or industrial applications",
                    "Ability to work in a fast-paced startup environment",
                ],
                "description": (
                    "Software Engineering Summer 2026 Internship at Laminar\n\n"
                    "Build and improve software systems powering Laminar's "
                    "AI-driven cleantech platform. Work alongside hardware and "
                    "ML engineers to deliver solutions for manufacturing clients.\n\n"
                    "Potential for full-time conversion. Based at Greentown Labs.\n\n"
                    "Source: https://runlaminar.com/careers"
                ),
            },
        ],
    },
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ADDITIONAL_JOBS = [
    # GlossGenius already in DB (seeded by Bessemer) with NYC Engineering Intern.
    # Adding the San Francisco office position.
    {
        "company_name": "GlossGenius",
        "jobs": [
            {
                "title": "Engineering Intern - San Francisco (Summer 2026)",
                "vertical": Vertical.SOFTWARE_ENGINEERING,
                "role_type": RoleType.SOFTWARE_ENGINEER,
                ...
                "salary_max": 8700,
                "requirements": [
                    "Pursuing B.S. in Computer Science or related technical field",
                    "Graduation date between 2027-2028",
                    "Proficiency in JavaScript/TypeScript, Ruby, or Kotlin",
                    "Familiarity with React, PostgreSQL, gRPC, or DataDog",
                ],
                "description": (
                    "Engineering Intern at GlossGenius (San Francisco SOMA office)\n\n"
                    "Join the team building the all-in-one platform for 100,000+ "
                    "beauty and wellness professionals. Work on booking, payments, "
                    "marketing, and analytics features. ~10 weeks, June-August 2026.\n\n"
                    "Source: https://job-boards.greenhouse.io/glossgenius/jobs/7600548003"
                ),
            },
        ],
    },
