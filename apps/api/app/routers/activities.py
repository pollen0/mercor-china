...
def _get_university_id(institution: str) -> Optional[str]:
    ...
    KNOWN_IDS = {
        ...
        # Batch 3: schools ranked ~50-100
        "vanderbilt", "notre_dame", "bu", "tufts", "rpi", "case_western",
        "pitt", "utah", "iowa_state", "michigan_state", "ucf", "gmu", "ucr",
        "rit", "wpi", "drexel", "stevens", "njit", "oregon_state", "buffalo",
        "utd", "uic", "clemson", "syracuse", "lehigh", "brandeis", "uconn",
        "iowa", "usf", "temple", "gwu", "tulane", "georgetown", "santa_clara",
        "missouri", "tennessee", "nebraska", "auburn", "smu", "colorado_state",
        "uoregon", "kansas", "binghamton", "delaware", "miami", "alabama",
        "uky", "wm", "lsu",
    }
    ...
    mapping = [
        ...
        # Batch 3: 49 new schools
        (["vanderbilt", "vandy"], "vanderbilt"),
        (["notre dame", "nd "], "notre_dame"),
        (["boston university", "bu "], "bu"),
        (["tufts"], "tufts"),
        (["rensselaer", "rpi"], "rpi"),
        (["case western", "cwru"], "case_western"),
        (["pittsburgh", "pitt"], "pitt"),
        (["university of utah", "utah "], "utah"),
        (["iowa state", "isu "], "iowa_state"),
        (["michigan state", "msu"], "michigan_state"),
        (["central florida", "ucf"], "ucf"),
        (["george mason", "gmu"], "gmu"),
        (["uc riverside", "ucr"], "ucr"),
        (["rochester institute", "rit "], "rit"),
        (["worcester poly", "wpi"], "wpi"),
        (["drexel"], "drexel"),
        (["stevens institute", "stevens tech"], "stevens"),
        (["new jersey institute", "njit"], "njit"),
        (["oregon state", "osu corvallis"], "oregon_state"),
        (["university at buffalo", "suny buffalo", "ub "], "buffalo"),
        (["ut dallas", "utd"], "utd"),
        ...
        (["south florida", "usf"], "usf"),
        (["temple"], "temple"),
        (["george washington", "gwu"], "gwu"),
        (["tulane"], "tulane"),
        (["georgetown"], "georgetown"),
        (["santa clara"], "santa_clara"),
        (["mizzou", "university of missouri"], "missouri"),
        (["university of tennessee", "ut knoxville"], "tennessee"),
        (["nebraska", "unl "], "nebraska"),
        (["auburn"], "auburn"),
        (["southern methodist", "smu"], "smu"),
        (["colorado state", "csu "], "colorado_state"),
        (["university of oregon", "uo "], "uoregon"),
        (["university of kansas", "ku "], "kansas"),
        (["binghamton", "suny binghamton"], "binghamton"),
        (["university of delaware", "udel"], "delaware"),
        (["university of miami", "um miami"], "miami"),
        (["university of alabama", "bama"], "alabama"),
        (["university of kentucky", "uky"], "uky"),
        (["william & mary", "william and mary", "w&m"], "wm"),
