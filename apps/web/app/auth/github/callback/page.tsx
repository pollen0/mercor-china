        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <div className="mx-auto w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4">
              <svg className="w-8 h-8 text-gray-800 animate-pulse" fill="currentColor" viewBox="0 0 24 24">
    ...
    <main className="min-h-screen bg-gradient-to-b from-teal-50 to-white flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Successfully connected as <span className="font-medium text-gray-900">@{githubUsername}</span>
          </CardDescription>
        </CardHeader>
