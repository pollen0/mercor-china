    ...
    <div className="space-y-4">
      ...
      <div className="relative aspect-video bg-black rounded-lg overflow-hidden">
        ...
        {state === 'recording' && remainingTime <= 30 && remainingTime > 0 && (
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-yellow-500 text-black px-4 py-2 rounded-full">
            <span className="text-sm font-medium">{remainingTime}s remaining</span>
          </div>
        )}
      </div>
      ...
      {state === 'preview' && (
        <p className="text-center text-sm text-gray-500">
          Review your recording. Click &quot;Use This Recording&quot; to submit, or &quot;Retry&quot; to record again.
        </p>
      )}
    </div>
  )
