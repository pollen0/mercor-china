  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Connect your Google Calendar to schedule interviews with employers
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {status?.connected ? (
          ...
          <div className="space-y-4">
            <div className="bg-stone-50 rounded-lg p-4">
              <h4 className="font-medium text-stone-900 mb-2">Connect to:</h4>
              <ul className="text-sm text-stone-600 space-y-1">
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  Schedule interviews directly on your calendar
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li className="flex items-center gap-2">
                  ...
                  Send invites with reminders to all attendees
                </li>
              </ul>
            </div>
