...
import { employerCalendarApi, CalendarStatus, ApiError } from '@/lib/api'

export function EmployerCalendarSettings() {
  ...
  const loadStatus = async () => {
    try {
      setLoading(true)
      const calendarStatus = await employerCalendarApi.getStatus()
  ...
  const handleDisconnect = async () => {
    if (!confirm('Are you sure you want to disconnect Google Calendar? You will not be able to schedule interviews until you reconnect.')) {
      return
    }
    ...
    try {
      ...
      setError(null)
      await employerCalendarApi.disconnect()
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Connect your calendar to schedule interviews with candidates
        </CardDescription>
      </CardHeader>
        ...
        {status?.connected ? (
          <div className="space-y-4">
            ...
            <div className="bg-stone-50 rounded-lg p-4">
              <h4 className="font-medium text-stone-900 mb-2">What you can do:</h4>
